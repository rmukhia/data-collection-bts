...
class ReasonCalculatorEvening2 extends React.Component {
  constructor(props) {
    super(props);
  ...
  buildQuestions() {
    return [ // evening 2
      {
        question: 'กรุณาระบุเหตุผลที่ท่านไม่สามารถเลื่อนเวลาการเดินทางเป็นก่อนเวลา 18.00 น. ได้',
        options: [
          'มีภาระด้านครอบครัว',
          'มีเวลาการออกงานหรือเลิกเรียน ที่แน่นอน เช่นยังไม่ถึงเวลาเลิกงานหรือยังไม่ถึงเวลาเลิกเรียน',
          ...
          <TextField
            hintText="อื่น ๆ"
            fullWidth
            onChange={(e, str) => this.handleTextChange('4.3.7', str)}
          />,
        ],
        id: '4.3.7',
      },
      {
        question: 'กรุณาระบุเหตุผลที่ท่านไม่สามารถเลื่อนเวลาการเดินทางหลังเวลา 20.00 น. ได้',
        options: [
          'มีภาระด้านครอบครัว',
          'มีเวลาการออกงานหรือเลิกเรียน ที่แน่นอน เช่นยังไม่ถึงเวลาเลิกงานหรือยังไม่ถึงเวลาเลิกเรียน',
          'มีเวลาการนัดหมายที่แน่นอน',
          ...
          <TextField
            hintText="อื่น ๆ"
            fullWidth
            onChange={(e, str) => this.handleTextChange('4.3.8', str)}
          />,
        ],
        id: '4.3.8',
      },
...
export default connect(mapStateToProps, mapDispatchToProps)(ReasonCalculatorEvening2);
