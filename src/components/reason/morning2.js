...
class ReasonCalculatorMorning2 extends React.Component {
  ...
  buildQuestions() {
    return [ // morning 1
      {
        question: 'กรุณาระบุเหตุผลที่ท่านไม่สามารถเลื่อนเวลาการเดินทางเป็นก่อนเวลา 07.30 น. ได้',
        options: [
      ...
      {
        question: 'กรุณาระบุเหตุผลที่ท่านไม่สามารถเลื่อนเวลาการเดินทางหลังเวลา 09.00 น. ได้',
        options: [
          'มีภาระด้านครอบครัว',
          'มีเวลาการเข้างาน หรือเข้าเรียน ที่แน่นอนเช่นไม่สามารถไปเข้างานหรือเข้าเรียนได้ทันเวลา',
          'มีเวลาการนัดหมายที่แน่นอน',
          'เนื่องจากไม่มีความยืดหยุ่นทางด้านการเดินทาง เช่น ต้องต่อรถหลายต่อ และมีเวลาการให้บริการที่แน่นอน',
          'เป็นช่วงที่รถไฟฟ้าแอร์พอร์ต เรล ลิงก์ มีความหนาแน่นมากกว่าเวลาที่ใช้อยู่เป็นประจำ',
          'การลดราคาไม่มีความจูงใจมากพอ',
      ...
      return (
        <div>
          <Paper zDepth={1} style={paperStyleNext}>
            <h3>แบบทดสอบช่วงเวลาเร่งด่วนช่วงเช้า ช่วงที่ 2 (07.30-09.00 น.)</h3>
          </Paper>
          <Question
