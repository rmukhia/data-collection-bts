...
class DiscountCalculatorMorning2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      currentIndex: 0,
  ...
  onNextClick() {
    ...
    if (curr < this.questions.length) {
      ...
      this.props.addToData('answers_morning2', this.state.answerMatrix);
      this.props.history.push('/reason/morning2');
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(DiscountCalculatorMorning2);
